...
{if isset($products) && $products}
    <div class="zoo_products_slide">
    <!-- Products list -->
        <div{if isset($id) && $id} id="{$id}"{/if} class="owl-carousel">
                        ...
                        <div class="left-block">
                            <div class="product-image-container">
                                <a class="product_img_link"	href="{$product.link|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}" itemprop="url">
                                    <img class="replace-2x {if $module_vars.slide_lazyload} lazyOwl {/if}img-responsive"
                                         {if $module_vars.slide_lazyload}data-src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:'html':'UTF-8'}"{/if}
                                         {if !$module_vars.slide_lazyload}src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:'html':'UTF-8'}"{/if}
